      ...
      <div className="container mt-5">
        <div className="row d-flex justify-content-center">
          <div className="input-section">
            <input
              className="col-sm-12 col-md-4 col-lg-4 col-xl-4 d-inline-block p-1 m-0"
              type="text"
            ...
            />
            <input
              className="col-sm-12 col-md-6 col-lg-6 col-xl-6 d-inline-block p-1 mt-2"
              type="text"
            ...
            />
            <button
              className=" btn1 d-none d-md-inline-block d-lg-inline-block d-xl-inline-block btn1 col-sm-4 col-md-2 col-lg-2  border rounded-2 fw-bolder text-white m-0 p-1"
            ...
            <div className="col-sm-12 d-sm-inlne-block d-md-none d-lg-none d-flex justify-content-center">
              <button
                className="d-inline-block  d-lg-none  btn1 col-sm-4 col-md-2 col-lg-2 border rounded-2 fw-bolder text-white p-2"
                onClick={handleAddTask}
              >
                Add Task
              </button>
                      ...
                      <div className="col-12 d-flex">
                        <div className="col-6">
                          <button
                            ...
                            className="Edit fw-bolder text-white"
                          >
                            Edit
                          </button>
                        </div>
                        <div className="col-6">
                          <button
                            className="Delete fw-bolder text-white"
